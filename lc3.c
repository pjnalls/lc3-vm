...
#pragma endregion
#pragma region Memory Mapped Registers
enum
{
...
#pragma region Memory Storage
#define MEMORY_MAX (1 << 16)
uint16_t memory[MEMORY_MAX]; /* 65,536 memory locations */
#pragma endregion
#pragma region Register Storage
uint16_t reg[R_COUNT];
#pragma endregion

#pragma region Input Buffering
...
#pragma endregion
#pragma region Handle Interrupt
